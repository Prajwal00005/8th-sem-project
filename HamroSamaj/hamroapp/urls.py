...
urlpatterns = [
    ...
    path('bills/admin/aggregate/', views.adminAggregateBills, name='admin-aggregate-bills'),
    path('bills/admin/aggregate/<int:bill_id>/status/', views.adminAggregateBillUpdateStatus, name='admin-aggregate-bill-update-status'),
