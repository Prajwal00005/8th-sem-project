...
const SuperadminDashboard = () => {
    const { currentPage, setCurrentPage, handleLogout, sidebarItems,fetchSubscriptionReminders, subscriptionReminders  } = useSuperadminDashboardStore();
                    ...
                    <div className="p-8 bg-[#F5F8F6]">
                        <div className="max-w-7xl mx-auto space-y-6">
                            <div>
                                ...
                                <p className="text-[#5C7361] mt-1">Monitor apartment managers feedback and trends</p>
                            </div>
                            {subscriptionReminders.length > 0 && subscriptionReminders[0].reminder !== 'No subscription payments due within the next 7 days.' && (
                                subscriptionReminders.map((reminder, index) => (
                                    (showReminders[reminder.admin_id] !== false) && (
                                        <div
                                            key={reminder.admin_id || index}
                                            className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-white border border-[#E8EFEA] shadow-lg rounded-lg p-4 max-w-md z-50 flex items-center justify-between"
                                            style={{ top: `${4 + index * 6}rem` }}
                                        >
                                            <div>
                                                <p className="text-sm font-medium text-[#2C3B2A]">{reminder.reminder}</p>
                                                <p className="text-xs text-[#5C7361]">Due: {reminder.due_date} ({reminder.days_until_due} days left)</p>
                                            </div>
                                            <button
                                                onClick={() => handleCloseReminder(reminder.admin_id)}
                                                className="ml-4 text-[#5C7361] hover:text-[#2C3B2A]"
                                            >
                            ...
                            {error ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <ChartCard
                                        ...
                                        description="Admin complaint status over the last 6 months"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-[#E8EFEA] p-6">
                                    <h3 className="text-lg font-medium text-[#2C3B2A] mb-4">Blog Management</h3>
                                    <button
                                        onClick={() => setCurrentPage('blogManagement')}
