    ...
    <div className="p-6 md:p-8 bg-gray-50 min-h-screen">
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-semibold text-gray-800">Bill Management</h2>
          <button
            type="button"
          ...
          <table className="min-w-full divide-y divide-gray-200 text-sm">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-2 text-left font-medium text-gray-700">Resident</th>
              ...
              {bills.length === 0 ? (
                ...
                bills.map((bill) => (
                  <tr key={bill.id}>
                    ...
                    <td className="px-4 py-2 text-gray-800">{bill.resident_name}</td>
                    ...
                    <td className="px-4 py-2 flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          if (window.confirm('Delete this bill?')) deleteBill(bill.id);
                        }}
          ...
          <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6">
              ...
              <div className="mb-4 text-sm text-gray-700 space-y-1">
                <p>
                  <span className="font-medium">Room:</span> {viewBill.room_number}
                </p>
                <p>
                  <span className="font-medium">Resident:</span> {viewBill.resident_name}
                </p>
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      value={billForm.room}
                      onChange={(e) =>
                        setBillForm({ room: e.target.value })
                      }
