      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-[#5C7361] mt-1">Manage your payment gateway and view salary payments</p>
          </div>
        </div>
          ...
          {isConnected ? (
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[#5C7361]">Active and ready to receive salary payments</p>
                </div>
              </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-[#5C7361] mb-8 max-w-md mx-auto">
                Set up your payment gateway to start receiving salary payments securely.
              </p>
              <button
